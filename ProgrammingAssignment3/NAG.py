...
model_3.save(filepath="NAG-250,400,100.h5", overwrite=False, include_optimizer=True)
...
model_3.save(filepath="NAG-125,250,100.h5", overwrite=False, include_optimizer=True)
...
model_3.save(filepath="NAG-784,500,100.h5", overwrite=False, include_optimizer=True)
