...
model_3.save(filepath="RMSProp-250,400,100.h5", overwrite=False, include_optimizer=True)
...
model_3.save(filepath="RMSProp-125,250,100.h5", overwrite=False, include_optimizer=True)
...
model_3.save(filepath="RMSProp-784,500,100.h5", overwrite=False, include_optimizer=True)
