...
model_3.save('AdaGrad-125,250,100.h5', overwrite=False, include_optimizer=True, )
...
model_3.save('AdaGrad-784,500,100.h5', overwrite=False, include_optimizer=True, )
