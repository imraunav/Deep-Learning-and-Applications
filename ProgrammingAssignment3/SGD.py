...
# # saving
# model_1.save(filepath="SGD_model1.h5", overwrite=True, include_optimizer=True)

# with open('SGD_history1.pkl', mode='wb') as f:
...
# # saving
# model_2.save(filepath="SGD_model2.h5", overwrite=True, include_optimizer=True)

# with open('SGD_history2.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# # plt.plot(history.history['loss'])
# # plt.xlabel('Epochs')
# # plt.ylabel('Adam') 
...
# # saving
# model_3.save(filepath="SGD_model3.h5", overwrite=True, include_optimizer=True)

# with open('SGD_history3.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# # plt.plot(history.history['loss'])
# # plt.xlabel('Epochs')
# # plt.ylabel('Adam') 
...
# optimizer
sgd = keras.optimizers.SGD(learning_rate=0.001, momentum=0.0,name='SGD')
earlystopping = keras.callbacks.EarlyStopping(monitor='loss',
                                              min_delta=1e-4,
                                              patience=1,
                                              verbose=1)
...
# saving
model.save(filepath="SGD_model4.h5", overwrite=True, include_optimizer=True)

with open('SGD_history4.pkl', mode='wb') as f:
    pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
plt.plot(history.history['loss'])
plt.xlabel('Epochs')
plt.ylabel('SGD')
