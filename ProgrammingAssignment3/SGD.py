...
model_3.save(filepath='SGD-250,400,100.h5', overwrite=False, include_optimizer=True)
# plt.figure()
# plt.title("SGD")
# plt.xlabel("Epochs")
# plt.ylabel("Loss")
...
model_3.save(filepath='SGD-125,250,100.h5', overwrite=False, include_optimizer=True)
...
model_3.save(filepath='SGD-784,500,100.h5', overwrite=False, include_optimizer=True)
