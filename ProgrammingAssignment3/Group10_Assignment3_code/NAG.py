...
# # optimizer
# sgd = keras.optimizers.SGD(learning_rate=0.001, momentum=0.9,name='NAG', nesterov=True)
...
# # saving
# model_1.save(filepath="NAG_model1.h5", overwrite=True, include_optimizer=True)

# with open('NAG_history1.pkl', mode='wb') as f:
...
# # saving
# model_2.save(filepath="NAG_model2.h5", overwrite=True, include_optimizer=True)

# with open('NAG_history2.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# # plt.plot(history.history['loss'])
# # plt.xlabel('Epochs')
# # plt.ylabel('Adam') 
...
# # saving
# model_3.save(filepath="NAG_model3.h5", overwrite=True, include_optimizer=True)

# with open('NAG_history3.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# plt.plot(history.history['loss'])
# plt.xlabel('Epochs')
# plt.ylabel('Adam') 
...
# saving
model.save(filepath="NAG_model4.h5", overwrite=True, include_optimizer=True)

with open('NAG_history4.pkl', mode='wb') as f:
    pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
plt.plot(history.history['loss'])
plt.xlabel('Epochs')
plt.ylabel('NAG') 
