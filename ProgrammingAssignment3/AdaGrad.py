...
# # saving
# model_1.save(filepath="adagrad_model1.h5", overwrite=True, include_optimizer=True)

# with open('adagrad_history1.pkl', mode='wb') as f:
...
# # saving
# model_2.save(filepath="adagrad_model2.h5", overwrite=True, include_optimizer=True)

# with open('adagrad_history2.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# # plt.plot(history.history['loss'])
# # plt.xlabel('Epochs')
# # plt.ylabel('Adam') 
...
# # saving
# model_3.save(filepath="adagrad_model3.h5", overwrite=True, include_optimizer=True)

# with open('adagrad_history3.pkl', mode='wb') as f:
#     pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
# # plt.plot(history.history['loss'])
# # plt.xlabel('Epochs')
# # plt.ylabel('Adam') 
...
# saving
model.save(filepath="adagrad_model4.h5", overwrite=True, include_optimizer=True)

with open('adagrad_history4.pkl', mode='wb') as f:
    pickle.dump(history.history, f, protocol=pickle.HIGHEST_PROTOCOL)
plt.plot(history.history['loss'])
plt.xlabel('Epochs')
plt.ylabel('AdaGrad') 
