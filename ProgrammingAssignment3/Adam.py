...
model_3.save(filepath="Adam-250,400,100.h5", overwrite=False, include_optimizer=True)
# plt.figure()
# plt.title("Adam")
# plt.xlabel("Epochs")
# plt.ylabel("Loss")
...
model_3.save(filepath="Adam-125,250,100.h5", overwrite=False, include_optimizer=True)
...
model_3.save(filepath="Adam-784,500,100.h5", overwrite=False, include_optimizer=True)
