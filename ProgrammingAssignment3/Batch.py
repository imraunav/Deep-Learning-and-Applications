...
model_3.save(filepath="Batch-250,400,100.h5", overwrite=False, include_optimizer=True)
# plt.figure()
# plt.title("Batch GD")
# plt.xlabel("Epochs")
# plt.ylabel("Loss")
...
# print('(Batch GD)Confusion matrix on test data:\n')
...
model_3 = keras.Sequential([
    Flatten(input_shape=(28,28), name='Input_layer'), # image data as input
    Dense(125, activation='sigmoid', name='Hidden_layer_1'),
    Dense(250, activation='sigmoid', name='Hidden_layer_2'),
    Dense(100, activation='sigmoid', name='Hidden_layer_3'),
    Dense(10, activation='softmax', name='Output')
], name='FCNN_3layer')
model_3.summary()
...
model_3.save(filepath="Batch-125,250,100.h5", overwrite=False, include_optimizer=True)


# 784,500,100
model_3 = keras.Sequential([
    Flatten(input_shape=(28,28), name='Input_layer'), # image data as input
    Dense(784, activation='sigmoid', name='Hidden_layer_1'),
    Dense(500, activation='sigmoid', name='Hidden_layer_2'),
    Dense(100, activation='sigmoid', name='Hidden_layer_3'),
    Dense(10, activation='softmax', name='Output')
], name='FCNN_3layer')
model_3.summary()
...
model_3.save(filepath="Batch-784,500,100.h5", overwrite=False, include_optimizer=True)
