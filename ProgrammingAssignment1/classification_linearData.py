...
from perceptron_v2 import perceptron # This class has been written by us
...
plt.plot(range(1, len(l_classifier.epoch_err_1)+1), l_classifier.epoch_err_1, label="Class 1 vs 2 perceptron")
plt.xlabel("Epoch")
plt.ylabel("Error")
plt.legend()
plt.subplot(3,1,2)
plt.plot(range(1, len(l_classifier.epoch_err_2)+1), l_classifier.epoch_err_2, label="Class 2 vs 3 perceptron")
plt.xlabel("Epoch")
plt.ylabel("Error")
plt.legend()
plt.subplot(3,1,3)
plt.plot(range(1, len(l_classifier.epoch_err_3)+1), l_classifier.epoch_err_3, label="Class 3 vs 1 perceptron")
plt.xlabel("Epoch")
plt.ylabel("Error")
plt.legend()
...
for sample in all_test:
    all_pred_labels.append(l_classifier.predict(sample=sample))
