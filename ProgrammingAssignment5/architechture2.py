...
def make_convnet():
    ...
    return Model(inputs=[image], outputs=[x], name="Architecture2")
...
def main():
    ...
    model.save(filepath="./ProgrammingAssignment5/models/architecture2.h5", overwrite=True, include_optimizer=True)
    with open("./ProgrammingAssignment5/logs/hist_arch2.pkl", mode="wb") as f:
